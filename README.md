This project generates a dataset for trade associations from the book volume
World Guide to Trade Associations, published in 2002. The book pages were
scanned to generate a jpg image file for each page. These are the inputs for
...
The generated CSV file is cleaned with the script ocr_cleanup.py.
